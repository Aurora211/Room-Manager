...
if ( $_SERVER[ 'REQUEST_METHOD' ] == "GET" && $_GET[ 'action' ] == "signout" ) {
	Logout();
		...
		<div class="page-content">
			...
			<div class="page-inner">
				<div class="page-title">
					<h3 class="breadcrumb-header"><strong>控制面板</strong></h3>
				</div>
				<div id="main-wrapper">
					<div class="row">
						<a href="profile.php">
							<div class="col-lg-3 col-md-6">
								<div class="panel panel-white stats-widget">
									<div class="panel-body">
										<div class="pull-left">
											<span class="stats-number"><strong>账户设置</strong></span>
											<p class="stats-info">Profile Settings</p>
										</div>
									</div>
								</div>
							</div>
						...
						<a href="requests.php">
							<div class="col-lg-3 col-md-6">
								<div class="panel panel-white stats-widget">
									<div class="panel-body">
										<div class="pull-left">
											<span class="stats-number"><strong>管理申请</strong></span>
											<p class="stats-info">Application Manager</p>
										</div>
									</div>
								</div>
							</div>
						...
						<a href="rooms.php">
							<div class="col-lg-3 col-md-6">
								<div class="panel panel-white stats-widget">
									<div class="panel-body">
										<div class="pull-left">
											<span class="stats-number"><strong>管理教室</strong></span>
											<p class="stats-info">Classroom Manager</p>
										</div>
									</div>
								</div>
							</div>
						...
						<a href="javascript:void(0)">
							<div class="col-lg-3 col-md-6">
								<div class="panel panel-white stats-widget">
									<div class="panel-body">
										<div class="pull-left">
											<span class="stats-number"><strong>管理管理员</strong></span>
											<p class="stats-info">Administrator Manager</p>
										</div>
									</div>
								</div>
							</div>
