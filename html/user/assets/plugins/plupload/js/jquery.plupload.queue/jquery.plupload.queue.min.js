...
(function (e, t) {
	...
	e.fn.pluploadQueue = function (s) {
		return s ? (this.each(function () {
			...
			function h() {
				e("span.plupload_total_status", a).html(u.total.percent + "%"), e("div.plupload_progress_bar", a).css("width", u.total.percent + "%"), e("span.plupload_upload_status", a).html(t.sprintf(r("已上传 %d/%d 文件"), u.total.uploaded, u.files.length))
			}
			...
			function p() {
				...
				}), e("span.plupload_total_file_size", a).html(plupload.formatSize(u.total.size)), u.total.queued === 0 ? e("span.plupload_add_text", a).html(r("添加文件")) : e("span.plupload_add_text", a).html(t.sprintf(r("%d 个已在队列"), u.total.queued)), e("a.plupload_start", a).toggleClass("plupload_disabled", u.files.length == u.total.uploaded + u.total.failed), n[0].scrollTop = n[0].scrollHeight, h(), !u.files.length && u.features.dragdrop && u.settings.dragdrop && e("#" + f + "_filelist").append('<li class="plupload_droptext">' + r("将文件拖至此处.") + "</li>")
			}
			...
			a = e(this), f = a.attr("id"), f || (f = plupload.guid(), a.attr("id", f)), l = a.html(), i(f, a), s = e.extend({
				...
				var i = n.file,
					s;
				i && (s = n.message, n.details && (s += " (" + n.details + ")"), n.code == plupload.FILE_SIZE_ERROR && alert(r("错误: 文件过大:") + " " + i.name), n.code == plupload.FILE_EXTENSION_ERROR && alert(r("错误: 不允许的文件格式:") + " " + i.name), i.hint = s, e("#" + i.id).attr("class", "plupload_failed").find("a").css("display", "block").attr("title", s)), n.code === plupload.INIT_ERROR && setTimeout(function () {
					d()
				}, 1)
			}), u.bind("PostInit", function (t) {
				t.settings.dragdrop && t.features.dragdrop && e("#" + f + "_filelist").append('<li class="plupload_droptext">' + r("将文件拖至此处") + "</li>")
