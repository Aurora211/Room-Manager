...
! function (a, b, c, d) {
	"use strict";
	var e = function (b, c) {
		this.widget = "", this.$element = a(b), this.defaultTime = c.defaultTime, this.disableFocus = c.disableFocus, this.disableMousewheel = c.disableMousewheel, this.isOpen = c.isOpen, this.minuteStep = c.minuteStep, this.modalBackdrop = c.modalBackdrop, this.orientation = c.orientation, this.secondStep = c.secondStep, this.showInputs = c.showInputs, this.showMeridian = c.showMeridian, this.showSeconds = c.showSeconds, this.template = c.template, this.appendWidgetTo = c.appendWidgetTo, this.showWidgetOnAddonClick = c.showWidgetOnAddonClick, this.maxHours = c.maxHours - 1, this._init()
	};
	e.prototype = {
		constructor: e,
		_init: function () {
		...
		decrementHour: function () {
			...
			else this.hour <= 0 ? this.hour = this.maxHours : this.hour--
		},
		...
		incrementHour: function () {
			...
			return this.hour === this.maxHours ? void(this.hour = 0) : void this.hour++
		},
		...
		maxHours: 24
	}, a.fn.timepicker.Constructor = e, a(c).on("focus.timepicker.data-api click.timepicker.data-api", '[data-provide="timepicker"]', function (b) {
		var c = a(this);
